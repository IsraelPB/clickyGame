...
class Game extends Component {
    ...
    render() {
        return (
            <div className="animated fadeIn" style={{  backgroundImage: "url(" + "https://vignette.wikia.nocookie.net/heart-of-souls-roleplay/images/1/15/Final_fantasy_7_life_stream_dreamscene_by_fallingkatanas-d6ujvpj.jpg/revision/latest?cb=20151018010407" + ")",
